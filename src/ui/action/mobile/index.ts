...
class ActionPluginMobile {
  ...
  load() {
    ...
    this.removeBlockButton.addEventListener(
      "touchstart",
      ActionPluginMobile.getButtonActionListener(actionBlockEvent.REMOVE, this)
    );
    this.removeBlockButton.addEventListener(
      "touchmove",
      ActionPluginMobile.getButtonActionListener(actionBlockEvent.REMOVE, this)
    ...
    this.createBlockButton.addEventListener(
      "touchstart",
      ActionPluginMobile.getButtonActionListener(actionBlockEvent.ADD, this)
    );
    this.createBlockButton.addEventListener(
      "touchmove",
      ActionPluginMobile.getButtonActionListener(actionBlockEvent.ADD, this)
    ...
    [this.jumpButton, this.removeBlockButton, this.createBlockButton, this.jumpDownButton, this.openMenuButton].forEach(
      (d) => {
