...
class ActionPluginXbox {
  ...
  checkAction(e) {
    ...
    if (this.gamepad.axes[2] !== 0)
      this.controller.gameController.handleViewAction({
        horizontal: this.gamepad.axes[2] * symConfig.xbox.viewMoveScale,
        vertical: 0
      });
    if (this.gamepad.axes[3] !== 0)
      this.controller.gameController.handleViewAction({
        horizontal: 0,
        vertical: -this.gamepad.axes[3] * symConfig.xbox.viewMoveScale
      });
